...
import com.github.daggerok.hello.api.GreetingMessage;
import com.github.daggerok.hello.api.HelloService;
import com.github.daggerok.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
  ...
  @Override
  public Topic<com.github.daggerok.hello.api.HelloEvent> helloEvents() {
    ...
    return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
      ...
      com.github.daggerok.hello.api.HelloEvent eventToPublish;
      ...
      if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
        ...
        eventToPublish = new com.github.daggerok.hello.api.HelloEvent.GreetingMessageChanged(
